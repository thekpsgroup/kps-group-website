...
export const SUITE: Suite[] = [
  {
    ...
    description:
      "Modern Brands creates ultra-modern logos, websites, and brand systems for service businesses. We focus on quiet luxury with bold impact, ensuring your brand stands out in today's competitive market.",
    painPoints: [
